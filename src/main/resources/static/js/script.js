...
//welcome message when user get loged into the system
...
Vue.component('login-component',{
    ...
    //after logedout it wont access the user to login into the system unless user once again loginto the system
    methods : {
        logOut(){
